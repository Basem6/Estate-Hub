...
export default function Category(){
    return(
        ...
        <div className="min-h-screen min-w-full bg-black">
            ...
            <Card  photo={"/images/pexels-necon-15987761.jpg"}  count={1} wrod={"Buy"} paragrag={"Browse thousands of verified properties using smart filters to find homes that match your budget, location, and lifestyle,Connect with a trusted real estate agent to ask questions, explore the property, and receive expert guidance,Finalize the paperwork, complete the payment securely, and get the keys to your new home."}></Card>
            <Card  photo={"/images/pexels-smail-dahmani-2278818-27268863.jpg"}  count={2} wrod={"Sell"} paragrag={"Discover a wide selection of homes for sale, from modern apartments to spacious family houses and luxury villas. Browse verified listings, compare prices, and find the perfect property to call your own."}></Card>
            <Card  photo={"/images/pexels-nguyendesigner-13600518.jpg"}  count={3} wrod={"Rent"} paragrag={"Find the perfect rental property that fits your lifestyle and budget. Browse verified apartments, houses, and villas with detailed information to make renting simple and stress-free."}></Card>
            ...
            <div className="photos flex flex-wrap gap-4 justify-between items-center p-6 md:p-20">
                <div className="photo size-100 relative grow">
                    <Image
                                        src="/images/pexels-necon-15987761.jpg"
                                        alt="buy"
                                        width={100}
                                        height={600}
